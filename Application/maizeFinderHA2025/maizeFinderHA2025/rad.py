...
base_path = "/Users/parnian/Documents/course/hatch/data/Corn"
...
def train_and_validate_model(model, train_dataloader, val_dataloader, loss_fn, optimizer, num_epochs, device):
    ...
    for epoch in range(1, num_epochs+1):
        ...
        if val_accuracy > val_best_accuracy:
            torch.save(model.state_dict(), f"11111resnext_model.pth")
...
if __name__ == '__main__':
    ...
    # Use ECA_SA_ResNeXtModel with pretrained weights (via the base model)
    logger.info("Initializing ECA_SA_ResNeXtModel with attention mechanisms...")
    ...
    # test_model_instance = test_model_instance.to(device)
        ...
        # Initialize a new model for testing
    test_model_instance = ECA_SA_ResNeXtModel(num_classes=4)
    test_model_instance = test_model_instance.to(device)
